	                ...
	                if (filaEsperaOficiais.isEmpty()) {
	                	try {
		                  ...
		                  //  System.out.println(categoria);
		                    ...
		                    if(categoria == 0) {System.out.println("Recruta zero deu uma pausa");}
		                    else if(categoria > 0) {System.out.println("Recruta Zero atendeu um cliente: " + getCategoriaString(categoria));}
	                ...
	                if (filaEsperaSargentos.isEmpty()) {
		                try {
		                  ...
		                  //  System.out.println(categoria);
		                    ...
		                    // Impressão da categoria do cliente atendido pelo Recruta Dentinho
		                    if(categoria == 0) {System.out.println("Recruta zero deu uma pausa");}
		                    else if(categoria > 0) {System.out.println("Barbeiro Dentinho atendeu um cliente: " + getCategoriaString(categoria));}
	                ...
	                if (filaEsperaCabos.isEmpty()) {
		                try {
		                  ...
		                  //  System.out.println(categoria);
		                    ...
		                    // Impressão da categoria do cliente atendido pelo Recruta Otto
		                    if(categoria == 0) {System.out.println("Recruta zero deu uma pausa");}
		                    else if(categoria > 0) {System.out.println("Barbeiro Otto atendeu um cliente: " + getCategoriaString(categoria));}
	        ...
	        Thread tenenteThread = new Thread(() -> {
	         ...
	         // Variáveis para rastrear o comprimento médio das filas
	            ...
	            while (dia < 1000) { // Executa a cada 1000 interações do Sargento Tainha
	                ...
	                System.out.println("\nEstado de ocupação das cadeiras:");
